        ...
        {moods.map(mood => {
          ...
          return (
            <button
              ...
              className="relative rounded-2xl p-4 sm:p-5 text-center transition-all duration-300 hover:scale-[1.04] active:scale-[0.97]"
              style={{
                background: isSelected ? c.active : 'rgba(220,38,38,0.09)',
                border: `1.5px solid ${isSelected ? c.border : 'rgba(220,38,38,0.20)'}`,
                boxShadow: isSelected ? `0 0 24px ${c.active}` : 'none',
              }}
            >
